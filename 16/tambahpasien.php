                ...
                <div class="col-4">
                    ...
                    <form action="koneksi.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mb-3" name="idPasien" placeholder="Nama Pasien">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="jk" value="Laki-lalki">Laki-laki
                            </div>
                        </div>
